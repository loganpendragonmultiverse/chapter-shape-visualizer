...
from chapter_shape_visualizer.cli import main
from chapter_shape_visualizer.core import PROJECT, analyze, render_json, render_markdown
...
def test_representative_sample_has_expected_result():
    ...
    assert len(report["chapters"]) == 2 and report["chapters"][0]["scenes"] == 2
